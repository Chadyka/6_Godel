...
public class AlternativTabella {
    ...
    public static void main(String[] args) {
        ...
        // az L mátrix kιszνtιsekori sorrend (a blogra kettιbontottban ez a Wikis keresttábla), 2011.03.11
        String[] csapatNevL = {
                "BFC Siófok",
                "Budapest Honvιd",
                "Vasas",
...
// itt hívjuk meg a Compareble interfészt
// egyetlen metódusa a compareTo, amivel a rendező
// metódusokra ( mint például Collections.sort() )
// tudunk hatni azzal hogy megadjuk az egymásra következő
// elemek rendezésének módját
class Csapat implements Comparable<Csapat> {
    ...
    // ez a metódus fogja irányítani a rendezésünket
    public int compareTo(Csapat csapat) {
        // ezzel a kóddal egy növekvő rendezést kapunk
        // amit akár egy Collections.sort() aztán pedig
        // egy Collections.reverse() is megadhatna, viszont a saját
        // osztályunkra külön rendezési módszert kell megadnunk
        // a compareTo() metódus felülírásával
